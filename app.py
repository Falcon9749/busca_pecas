...
def scrape_data():
    ...
    parts_to_search = [
        ...
        "cilindro de roda",
        "cilindro mestre",
        "cobertura da grade do radiador",
        "coletor de admissão",
        "coletor de escape",
        "coluna do parabrisas lado direito",
        "coluna do parabrisas lado esquerdo",
        ...
        "coxim do motor",
        "cubo de roda",
        "defletor do intercooler",
        "defletor dir do radiador",
        "disco de freio",
        "dobradiça dir do capô",
        "dobradiça esq do capô",
        "eletroventilador",
        ...
        "garfo de embreagem",
        "grade do radiador",
        "grade inf do parachoque diant",
        "guia dir do parachoque diant",
        "guia esq do parachoque diant",
        "homocinética",
        "intercooler",
        "interruptor de oleo",
        "interruptor de ré",
        ...
        "silencioso traseiro",
        "sonda lambda",
        "suporte sup dir parachoque diant",
        "suporte sup esq parachoque diant",
        "suporte do radiador",
        "tambor de freio",
        "tensor da correia",
        "terminal de direção",
        "travessa inf do painel diant",
        "travessa sup do painel diant",
        "trizeta",
        "tubo de escape",
        "turbina",
        "válvula de alivio",
